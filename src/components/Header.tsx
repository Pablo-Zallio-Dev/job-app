...
const Header = () => {
      ...
      return (
            ...
            <section className=" bg-blue-900/10 border-b border-borderColor ">
                  ...
                  <section className="  fixed lg:hidden z-40 bottom-15 right-15 p-3 backdrop-blur-md bg-gray-500/20 border border-gray-600 rounded-xl " onClick={changeMenuState}>
                        <GiHamburgerMenu />
                  </section>
                  <JobStats />
            </section>
